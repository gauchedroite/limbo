...
export class FactSet implements IStatementIterator {
    ...
    getdone() { return this.done; }
    getFacts(whoid: number, name: FactKind): Facts {
...
export class Rules {
    ...
    findMatchingRule(factset: FactSet): Rule {
